...
string(JSON CALLBACK_ENUM_NAME GET "${REDUCED_CONTENT}" enums 0 name)
string(JSON CALLBACK_ENUM_UNDERLYING_TYPE GET
       "${REDUCED_CONTENT}" enums 0 underlyingType)
string(JSON CALLBACK_ENUM_VALUE GET
       "${REDUCED_CONTENT}" enums 0 values 1 value)
string(JSON CALLBACK_ENUM_DOC GET "${REDUCED_CONTENT}" enums 0 doc brief)
string(JSON CALLBACK_ENUM_VALUE_DOC GET
       "${REDUCED_CONTENT}" enums 0 values 1 doc brief)
if(NOT ALIAS_CALLBACK_NAME STREQUAL "error_code" OR
   NOT ALIAS_CALLBACK_TYPE STREQUAL "ErrorCode" OR
   ...
   NOT LEGACY_CALLBACK_SECOND_TYPE STREQUAL "void *" OR
   NOT CALLBACK_ENUM_NAME STREQUAL "ErrorCode" OR
   NOT CALLBACK_ENUM_UNDERLYING_TYPE STREQUAL "int" OR
   NOT CALLBACK_ENUM_VALUE STREQUAL "1" OR
   NOT CALLBACK_ENUM_DOC STREQUAL "Error reported by a callback." OR
   NOT CALLBACK_ENUM_VALUE_DOC STREQUAL "The operation failed.")
