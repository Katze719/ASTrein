...
string(JSON ENUM_COUNT LENGTH "${ACTUAL}" enums)
string(JSON FLOW_ENUM_NAME GET "${ACTUAL}" enums 0 name)
string(JSON FLOW_ENUM_UNDERLYING_TYPE GET
       "${ACTUAL}" enums 0 underlyingType)
string(JSON FLOW_ENUM_SCOPED GET "${ACTUAL}" enums 0 scoped)
string(JSON FLOW_ENUM_VALUE GET "${ACTUAL}" enums 0 values 2 value)
string(JSON FLOW_ENUM_VALUE_DOC GET
       "${ACTUAL}" enums 0 values 2 doc brief)
string(JSON PARITY_ENUM_NAME GET "${ACTUAL}" enums 1 name)
string(JSON PARITY_ENUM_VALUE GET "${ACTUAL}" enums 1 values 1 value)
string(JSON STOP_BITS_ENUM_NAME GET "${ACTUAL}" enums 2 name)
string(JSON STOP_BITS_ENUM_VALUE GET "${ACTUAL}" enums 2 values 1 value)
...
string(JSON VALUE_STRUCT_PARITY_FIELD_TYPE GET
       "${ACTUAL}" structs 3 fields 2 type)
string(JSON VALUE_STRUCT_FLOW_FIELD_OFFSET GET
       "${ACTUAL}" structs 3 fields 4 offset)
string(JSON VALUE_STRUCT_FLOW_FIELD_DOC GET
       "${ACTUAL}" structs 3 fields 4 doc brief)
...
if(NOT STRUCT_COUNT EQUAL 4 OR
   NOT ENUM_COUNT EQUAL 3 OR
   NOT FLOW_ENUM_NAME STREQUAL "FlowControl" OR
   NOT FLOW_ENUM_UNDERLYING_TYPE STREQUAL "int" OR
   NOT FLOW_ENUM_SCOPED OR
   NOT FLOW_ENUM_VALUE STREQUAL "2" OR
   NOT FLOW_ENUM_VALUE_DOC STREQUAL
       "Use software XON/XOFF flow control." OR
   NOT PARITY_ENUM_NAME STREQUAL "Parity" OR
   NOT PARITY_ENUM_VALUE STREQUAL "1" OR
   NOT STOP_BITS_ENUM_NAME STREQUAL "StopBits" OR
   NOT STOP_BITS_ENUM_VALUE STREQUAL "2" OR
   ...
   NOT VALUE_STRUCT_SIZE EQUAL 24 OR
   ...
   NOT VALUE_STRUCT_PARITY_FIELD_TYPE STREQUAL "Parity" OR
   NOT VALUE_STRUCT_FLOW_FIELD_OFFSET EQUAL 20 OR
   NOT VALUE_STRUCT_FLOW_FIELD_DOC STREQUAL "Flow-control mode." OR
   ...
   NOT STRUCT_VALUE_PARAMETER_SIZE EQUAL 24 OR
